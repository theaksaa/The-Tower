...
public class MainMenuController : MonoBehaviour
{
    ...
    [SerializeField] private string runOverviewSceneName = GameScenes.RunOverview;
    ...
    {
        var saves = RunPersistenceService.GetAllRuns();
    ...
    private void BindContinueRunCard(ContinueRunCardView card, RunSaveSummary save)
    {
    ...
    private static Sprite ResolveRunHeroSprite(RunSaveSummary save, Sprite fallbackSprite)
    {
